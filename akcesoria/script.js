...
const of9 = document.querySelector(".of9");
...
bt77.addEventListener("click", function () {
    of0.classList.add("none")
    of1.classList.remove("active")
    of2.classList.remove("active")
    of3.classList.remove("active")
...
bt88.addEventListener("click", function () {
    of0.classList.add("none")
    of1.classList.remove("active")
    of2.classList.remove("active")
    of3.classList.remove("active")
...
$('.item8').on('click', function () {
    $('body,html').animate({
        scrollTop: $('.s8').offset().top - $('.s0').offset().top
    })
})

$('.item9').on('click', function () {
    $('body,html').animate({
        scrollTop: $('.s9').offset().top - $('.s0').offset().top
    })
})
